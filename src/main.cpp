...
#if defined(NDEBUG)
# error "Zcashdark cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x1271bc7c1187c6fab92cffb349ea37721b3da65f15d552c714e220f4d53a2e46");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Zcashdark: starting difficulty is 1 / 2^12
...
{
    // Zcashdark: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Zcashdark: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // Zcashdark: 5 minutes
static const int64 nTargetSpacing = 1 * 30; // Zcashdark: 30 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Zcashdark: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Zcashdark: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1271bc7c1187c6fab92cffb349ea37721b3da65f15d552c714e220f4d53a2e46");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Isto é Zcashdark seu novo metodo de pagamento";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1511282742;
        ...
        assert(block.hashMerkleRoot == uint256("0x20b4c1d47e3a79a39bbbed6aa7afbd3508cdf06e1ee158b571768a7641c15901"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Zcashdark: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ZcashdarkMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ZcashdarkMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static ZcashdarkMiner(CWallet *pwallet)
{
    printf("ZcashdarkMiner started\n");
    ...
    try { loop {
        ...
        printf("Running ZcashdarkMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("ZcashdarkMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&ZcashdarkMiner, pwallet));
}
